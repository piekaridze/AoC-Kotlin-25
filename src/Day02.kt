...
private fun isTwoSameSequencesWithStringSolution(id: Long): Boolean {
    val asString = id.toString()
    return asString.length % 2 == 0 &&
            asString.take(asString.length / 2) == asString.substring(asString.length / 2)
}

private fun isTwoSameSequencesWithDividingSolution(id: Long): Boolean {
 ...
 */
private fun isInvalidIdSameSequenceAtLeastTwice(id: Long): Boolean {
